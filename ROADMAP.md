...
5. **Menu flow.** Title screen, How To Play, Pause menu, Level Complete, All Levels Complete, as a DOM overlay over the Canvas2D game world. Decided: [ADR 0006](docs/adr/0006-dom-overlay-for-ui-chrome.md), [issue #32](https://github.com/philjhale/rebounder-ts/issues/32). Credits screen dropped — not ported.
